<%@ Control Language="C#" AutoEventWireup="true" CodeFile="navigationLBB.ascx.cs"
    Inherits="LeaderBedBooking_controls_navigationLBB" EnableViewState="false" Debug="false" %>
<!-- Static navbar -->
<div class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/mainmenu.aspx">Atlas</a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Leader
                    Profile <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="/LeaderProfile.aspx">Name and Address</a></li>
                        <li><a href="/LeaderAvailability.aspx">Availability</a></li>
                        <li class="divider"></li>
                        <li class="dropdown-header">Preferences</li>
                        <li><a href="/LeaderAreaPreference.aspx">Area</a></li>
                        <li><a href="/LeaderPersonPreference.aspx">Co-Leader</a></li>
                        <li><a href="/LeaderPreferenceAmountOfWork.aspx">Amount of Work</a></li>
                    </ul>
                </li>
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Portfolio<b
                    class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="/LPActivity.aspx">Activity</a></li>
                        <li><a href="/LPTravel.aspx">Travel</a></li>
                        <li><a href="/LeaderCertifications.aspx">Certifications</a></li>
                        <li><a href="/LPOtherExperience.aspx">Other Experience</a></li>
                        <li class="divider"></li>

                        <li class="dropdown-header">Payroll</li>
                        <li><a href="/PayrollCurrent.aspx">Current</a></li>
                        <li><a href="/PayrollPast.aspx">Past</a></li>
                    </ul>
                </li>
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Schedules<b
                    class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="/ViewLeaderSchedule.aspx">Leader Schedule</a></li>
                        <li><a href="/ViewTripSchedule.aspx">Trip Schedule</a></li>
                        <li><a href="/ViewUnitSchedule.aspx">Unit Schedule</a></li>
                        <li><a href="/ViewAreaSchedule.aspx">Area Schedule</a></li>
                        <li class="divider"></li>
                        <li class="dropdown-header">Schedule Preferences</li>
                        <li><a href="/LeaderTraining.aspx">Training</a></li>
                        <li><a href="/LeaderTravelProfile.aspx">Global Travel Preferences</a></li>
                        <li><a href="/Scheduling.aspx">Scheduling Preference Summary</a></li>
                    </ul>
                </li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li><a href="/EmployeeHandbook.aspx">Employee Handbook</a></li>
...
menu[0][5] = new Item('Payroll Info', '#', defHeight, 5);
menu[0][6] = new Item('Employee Handbook', '#', defHeight, 8);
...
menu[5] = new Array();
menu[5][0] = new Menu('payrollMenu', 0, 22, 130, defOver, defBack, defBorder);
menu[5][1] = new Item('Current Payroll', 'PayrollCurrent.aspx', defHeight, 0);
menu[5][2] = new Item('Past Payroll', 'PayrollPast.aspx', defHeight, 0);

menu[6] = new Array();
// This is across but not down... a horizontal popout (with crazy colours :)...
menu[6][0] = new Menu('preferenceMenu', 145, 0, 110, defOver, defBack, defBorder);
menu[6][1] = new Item('Area', 'LeaderAreaPreference.aspx', defHeight, 0);
menu[6][2] = new Item('Co-Leader', 'LeaderPersonPreference.aspx', defHeight, 0);
menu[6][3] = new Item('Amount of Work', 'LeaderPreferenceAmountOfWork.aspx', defHeight, 0);
menu[6][4] = new Item('Scheduling Preference Summary', 'Scheduling.aspx', defHeight, 0);


menu[7] = new Array();
menu[7][0] = new Menu('portfolioMenu', 145, 0, 110, defOver, defBack, defBorder);
menu[7][1] = new Item('Activity', 'LPActivity.aspx', defHeight, 0);
menu[7][2] = new Item('Travel', 'LPTravel.aspx', defHeight, 0);
menu[7][3] = new Item('Other Experience', 'LPOtherExperience.aspx', defHeight, 0);


menu[8] = new Array();
menu[8][0] = new Menu('EmployeeHandbookMenu', 0, 22, 130, defOver, defBack, defBorder);
...
newRoot += startDL('rootMenu8', 595, 1, 215, 15, 'inherit', defBase, null, 100, '');
